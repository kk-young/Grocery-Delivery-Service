<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <String label="DeliveryAddress" v-model="item.deliveryAddress" :editMode="editMode" @change="change" />
            </div>
            <div>
                <String label="DeliveryTime" v-model="item.deliveryTime" :editMode="editMode" @change="change" />
            </div>
        </v-card-text>
