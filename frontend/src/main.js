...
pluralCaseList.push( {plural: "deliveryDrivers", pascal: "DeliveryDriver"} )
pluralCaseList.push( {plural: "groceryItems", pascal: "GroceryItem"} )

pluralCaseList.push( {plural: "deliveryDriverProfiles", pascal: "DeliveryDriverProfile"} )
